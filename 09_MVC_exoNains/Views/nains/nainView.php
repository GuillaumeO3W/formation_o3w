...
<div class="section">
  <div class="card is-shadowless">
    <div class="card-content">
      ...
      <p>Travaille de <?= $nain->getDebut()." à ".$nain->getFin() ?> dans le tunnel de <?= "<a href=\"index.php?ctrl=ville&action=villeView&id=".$nain->getDepartId() ."\">".$nain->getDepart()."</a> à <a href=\"index.php?ctrl=ville&action=villeView&id=".$nain->getArriveeId() ."\">".$nain->getArrivee()."</a>" ?></p>
