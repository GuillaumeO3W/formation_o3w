...
<div class="fixed-top">
    <ul class="nav nav-underline justify-content-center">
        <li class="nav-item"><a class="nav-link"  href="<?= $_SESSION['role'] ?>1.php">page <?= $_SESSION['role'] ?> 1</a></li>
        <li class="nav-item"><a class="nav-link"  href="<?= $_SESSION['role'] ?>2.php">page <?= $_SESSION['role'] ?> 2</a></li>
        <li class="nav-item"><a class="nav-link"  href="<?= $_SESSION['role'] ?>3.php">page <?= $_SESSION['role'] ?> 3</a></li>
